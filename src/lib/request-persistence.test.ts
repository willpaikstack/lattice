  ...
  files: [
    {
      ...
      cadPreviewUrn: "translated-bracket-a-urn",
    },
  ],
  revision: {
...
describe("request persistence", () => {
  ...
  it("maps a stored Prisma request record into the app request model", () => {
    const stored = {
      ...
      quoteSummary: "",
      purchasePaymentMethod: "PURCHASE_ORDER",
      purchasePaymentStatus: "PENDING_REVIEW",
          ...
          lineItems: [
            {
              ...
              process: "CNC milling",
              quantity: 12,
              supplierNotes: "Confirm tapped holes before production.",
              unitPrice: 104.16,
            },
          ],
      ...
      customerPurchaseOrderAttachment: {
        ...
        sizeBytes: 8192,
        type: "application/pdf",
        storageKey: "customer-purchase-orders/2026-06-02/amogy-po-1047.pdf",
