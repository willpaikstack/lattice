...
export const productRoadmapItems: ProductRoadmapItem[] = [
  ...
  {
    category: "Services",
    customerValue: "Pay approved Lattice quotes by card through a tested, reliable checkout flow.",
    horizon: "Later",
    id: "production-card-payments",
    signals: ["Live Stripe keys and webhook", "Controlled live payment and refund/void test", "Company-owned payment methods and reconciliation"],
    status: "Planned",
    summary: "Commission and validate Stripe card payments in Production, including webhook reconciliation and a controlled live payment test, before making in-app checkout available to customers.",
    title: "Production Card Payments",
  },
  {
    category: "Services",
    customerValue: "Confirm a company's shipping and billing details quickly and accurately on first use.",
    horizon: "Next",
    id: "guided-address-onboarding-and-autocomplete",
    signals: ["Dedicated shipping then billing steps", "Review-and-confirm prefilled company details", "Address suggestions from a production address-validation provider"],
    status: "Planned",
    summary: "Replace the Account Settings-based first-login address task with focused shipping and billing onboarding screens, including provider-backed address autocomplete and a clear review/confirmation step.",
    title: "Guided Address Onboarding and Autocomplete",
  },
  {
    category: "Services",
