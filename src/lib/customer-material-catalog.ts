...
const canonicalGradeAliases: Partial<Record<MaterialOfferingCategory, Record<string, string>>> = {
  ...
  "Stainless Steel": {
    ...
    "ss 303": "303",
    "304": "304/304L Stainless Steel",
    "304 stainless steel": "304/304L Stainless Steel",
    "ss 304": "304/304L Stainless Steel",
    "ss 304 / 1.4301": "304/304L Stainless Steel",
    "304l": "304/304L Stainless Steel",
    "304l stainless steel": "304/304L Stainless Steel",
    "ss 304l": "304/304L Stainless Steel",
    "316": "316/316L Stainless Steel",
    "316 stainless steel": "316/316L Stainless Steel",
    "ss 316": "316/316L Stainless Steel",
    "316l": "316/316L Stainless Steel",
    "316l stainless steel": "316/316L Stainless Steel",
    "ss 316l": "316/316L Stainless Steel",
    "ss 316 / 1.4404": "316/316L Stainless Steel",
    "ss 304h": "304H",
    "ss 316h": "316H",
...
const customerMaterialCatalogEntries: CustomerMaterialCatalogEntry[] = [
  {
    ...
    materialGroups: groupGrades(aluminumGrades, [
      ...
      { name: "2000 series", matches: (grade) => /\b2A12\b|\b2A14\b|\b2007\b|\b2014\b|\b2017A?\b|\b2024\b/.test(grade) },
      { name: "3000 series", matches: (grade) => /\b3003\b/.test(grade) },
      { name: "5000 series", matches: (grade) => /\b5052\b|\b5083\b|\b5251\b|\b5754\b/.test(grade) },
      { name: "6000 series", matches: (grade) => /\b6060\b|\b6061\b|\b6063\b|\b6082\b/.test(grade) },
      { name: "7000 series", matches: (grade) => /\b7050\b|\b7075\b/.test(grade) },
  ...
  },
  {
    ...
    materialGroups: groupGrades(stainlessGrades, [
      { name: "300 series austenitic", matches: (grade) => /\b30[12349]\b|303Se|303Sulf|304|304L|304H|310|310S|316|316L|316H|316Ti|321|330|347|347H|18-8/i.test(grade) },
      { name: "400 series martensitic/ferritic", matches: (grade) => /\b40|410|416|420|430|431|440|1\.4005|1\.4305|20Cr13|40Cr13/i.test(grade) },
      { name: "Precipitation-hardened stainless steels", matches: (grade) => /13-8|15-5|17-4|630|Custom 455|PH/i.test(grade) },
