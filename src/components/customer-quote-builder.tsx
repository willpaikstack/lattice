  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[1.05fr_0.95fr]">
      <div className="space-y-5">
        <section className="rounded-md border border-[#ffd1d4] bg-white p-5">
          {requestId ? <p className="mb-4 rounded-md bg-[#fff1f2] px-3 py-2 text-sm font-semibold text-[#767676]">Linked RFQ: {requestId}</p> : null}
          <div className="mb-4">
            <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-[#767676]">Quote identity</p>
        ...
        <section className="rounded-md border border-[#ffd1d4] bg-white">
          <div className="flex flex-col gap-3 border-b border-[#eeeeee] px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-[#767676]">Part production</p>
        ...
        <section className="rounded-md border border-[#ffd1d4] bg-white p-5">
          <div className="mb-4">
            <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-[#767676]">Logistics and terms</p>
      ...
      <aside className="space-y-5 xl:sticky xl:top-5 xl:self-start">
        <section className="rounded-md border border-[#ffd1d4] bg-[#fff7f7] p-5">
          <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-[#767676]">Customer quote file</p>
          ...
          <form action={saveAction} className="mt-4 flex flex-col gap-2 sm:flex-row">
            ...
            {saveAction ? (
              <button className="inline-flex items-center justify-center gap-2 rounded-md bg-[#FF5A5F] px-4 py-2 text-sm font-semibold text-white transition hover:bg-[#484848]" type="submit">
