...
import { AdminCompanyUserManagement } from "@/components/admin-company-user-management";
...
function Field({
  ...
  return (
    <label className="grid gap-2 text-sm font-semibold text-slate-700 md:grid-cols-[10rem_minmax(0,1fr)] md:items-center md:gap-4">
      <span>{label}</span>
      <input
...
export function AdminCustomerProfileDetail({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-5">
        <AdminCompanyUserManagement companyId={profile.id} users={profile.users} />

        <details className="group rounded-md border border-[#e6e6e6] bg-white">
          <summary className="flex cursor-pointer list-none items-center justify-between gap-4 p-5 marker:content-none">
            ...
            <span className="rounded-md border border-slate-200 px-3 py-1.5 text-[13px] font-semibold text-slate-600 transition group-open:hidden">Show details</span>
            <span className="hidden rounded-md border border-slate-200 px-3 py-1.5 text-[13px] font-semibold text-slate-600 transition group-open:inline">Hide details</span>
          </summary>
          <form action={updateAction} className="space-y-4 px-5 pb-5">
            ...
            <label className="grid gap-2 text-sm font-semibold text-slate-700 md:grid-cols-[10rem_minmax(0,1fr)] md:items-start md:gap-4">
